...
class WC_Gateway_kmnd_Assetpayments_V2 extends WC_Payment_Gateway {
    ...
    public function __construct() {
            ...
            global $woocommerce;
            $this->id = 'assetpayments-v2';
            $this->has_fields = false;
            $this->method_title = 'AssetPayments V2 (https://assetpayments.com)';
            $this->method_description = __('Payment system AssetPayments V2', 'wc-assetpayments-v2');
            ...
            add_action('woocommerce_api_wc_gateway_assetpayments_v2', array($this, 'check_ipn_response'));
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
                'enabled' => array(
                    'title'   => __('Turn on/Switch off', 'wc-assetpayments-v2'), // CORRECTED
                    'type'    => 'checkbox',
                    'label'   => __('Turn on', 'wc-assetpayments-v2'),
                    'default' => 'yes',
                ),
    ...
    public function generate_form($order_id) {
        ...
        $result_url = add_query_arg('wc-api', 'WC_Gateway_Assetpayments_V2', home_url('/'));
        ...
        $redirect_page_url = add_query_arg('assetpayments_v2_redirect', '1', add_query_arg('order_id', $order_id, add_query_arg('key', $order->order_key, home_url('/'))));
        $redirect_page_url = str_replace('/?assetpayments_v2_redirect=1', '/?assetpayments_v2_redirect=1', $redirect_page_url);

            $request_cart = array();
            $request_cart['Products'] = array();
  			$request_cart['Products'] = apply_filters( 'woocommerce_assetpayments_v2_cart', $request_cart['Products'], $order_id );
