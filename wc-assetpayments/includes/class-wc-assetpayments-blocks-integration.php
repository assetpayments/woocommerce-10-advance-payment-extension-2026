...
final class WC_AssetPayments_Blocks_Integration extends AbstractPaymentMethodType {

    /**
     * Payment method name/id used by Blocks.
     * Must match your gateway $this->id
     */
    protected $name = 'assetpayments';

    public function initialize() {
        $this->settings = get_option('woocommerce_assetpayments_settings', array());
    }
    ...
    public function get_payment_method_script_handles() {
        wp_register_script(
            'wc-assetpayments-blocks',
            plugins_url('assets/js/blocks.js', WC_ASSETPAYMENTS_PLUGIN_FILE),
        ...
        wp_add_inline_script(
            'wc-assetpayments-blocks',
            'window.wcAssetPaymentsData = ' . wp_json_encode($data) . ';',
            'before'
        );

        return array('wc-assetpayments-blocks');
    }
